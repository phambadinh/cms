    ...
    <header className="app-header-shell">
      <div className="app-header-bar">
        ...
        <form className="app-header-searchbox" onSubmit={handleSearch}>
          <Search size={16} className="app-header-search-icon" strokeWidth={2} aria-hidden="true" />
          <input
            type="text"
        ...
        <div className="app-header-account">
          {user ? (
            ...
            <div className="app-auth-actions">
              <button type="button" className="app-auth-login" onClick={() => navigate("/login")}>
                Đăng nhập
              </button>
              <button type="button" className="app-auth-register" onClick={() => navigate("/register")}>
                Đăng ký
              </button>
            </div>
          )}
