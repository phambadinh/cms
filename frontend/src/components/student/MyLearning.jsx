  ...
  return (
    <div className="my-learning-page">
      <div className="learning-hero">
        ...
        <p>
          Theo dõi tiến độ học tập và tiếp tục hành trình chinh phục kiến thức.
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="empty-learning">
          <BookMarked size={72} className="empty-icon" />
          <h3>Chưa có khóa học nào</h3>
          <p>Hãy ghi danh khóa học đầu tiên để bắt đầu hành trình học tập.</p>
        </div>
      ) : (
        <>
            ...
            {enrollments.map((item) => (
              <div key={item.id} className="my-course-card">
                ...
                <div className="my-course-card-content">
                  ...
                  <p>Tiếp tục hành trình học tập và hoàn thành khóa học của bạn.</p>
                  ...
                  <button className="continue-btn" onClick={() => navigate(`/learning/${item.courseId}`)}>
          ...
          <div className="study-tip">
            ...
            <div>
              <h3>Mẹo học tập</h3>
              <p>
                Duy trì học tập 30 phút mỗi ngày sẽ giúp bạn hoàn thành khóa học nhanh hơn và ghi nhớ
                kiến thức tốt hơn.
              </p>
            </div>
          </div>
