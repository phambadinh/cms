...
function LearningProgress() {
  ...
  const enrolledCourses =
    getStat("Khóa đã đăng ký");

  const activeCourses =
    getStat("Đang học");

  const completedCourses =
    getStat("Đã hoàn thành");

  const completedLessons =
    getStat("Bài học hoàn thành");

  const quizAttempts =
    getStat("Lượt quiz");

  const averageProgress =
    getStat("Tỷ lệ hoàn thành");
  ...
  return (
    <div className="learning-progress-page">
      <div className="progress-hero">
        ...
        <p>
          Theo dõi hành trình học tập và
          hoàn thành các khóa học của bạn.
        </p>
      </div>
